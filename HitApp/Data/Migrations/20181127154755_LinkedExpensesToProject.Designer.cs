...
namespace HitApp.Data.Migrations
{
    ...
    [Migration("20181127154755_LinkedExpensesToProject")]
    partial class LinkedExpensesToProject
    {
            ...
            modelBuilder.Entity("HitApp.Models.Expense", b =>
                {
                    ...
                    b.HasData(
                        new { ExpenseId = 1, ExpenseName = "TestExpense1", ExpenseNotes = "This is a test", ExpenseTotalCost = 420.0, ProjectId = 1 }
                    );
                });
